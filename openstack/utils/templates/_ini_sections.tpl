...
transport_url = rabbit://{{ .Values.audit.central_service.user | required "Please set audit.central_service.user" }}:{{ .Values.audit.central_service.password | required "Please set audit.central_service.password" | urlquery }}@{{ .Values.audit.central_service.host | required "Please set audit.central_service.host" }}:{{.Values.audit.central_service.port | default 5672 }}/
